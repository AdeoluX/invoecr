...
const { addBankSchema, editEntitySchema, addMemberSchema } = require('../validations/entity.validations');
...
//entity
router.patch(`${BASE}`, validateReq(editEntitySchema), Authorization.authenticateToken, EntityController.editEntity);
router.post(`${BASE}/add-member`, validateReq(addMemberSchema), Authorization.authenticateToken, EntityController.addMember)
